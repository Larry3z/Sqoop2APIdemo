...
public class HDFSToMysql {
    ...
    public static void sqoopTransfer() {
        ...
        fromLinkConfig.getStringInput("linkConfig.uri").setValue("hdfs://127.0.0.1:9000");
        ...
        toLinkConfig.getStringInput("linkConfig.connectionString").setValue("jdbc:mysql://Master:3306/hive");
        ...
        toLinkConfig.getStringInput("linkConfig.password").setValue("test1.");
        ...
        fromJobConfig.getStringInput("fromJobConfig.inputDirectory").setValue("/home/sqoop/20160902");

        //创建目的地链接任务配置信息
        MToConfig toJobConfig = job.getToJobConfig();
        toJobConfig.getStringInput("toJobConfig.schemaName").setValue("hive");
        toJobConfig.getStringInput("toJobConfig.tableName").setValue("workers2");
